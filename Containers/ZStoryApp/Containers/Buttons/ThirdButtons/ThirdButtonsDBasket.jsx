...
import {
  DriveBRush,
  DriveBRun,
  QuitBeforeThirdStoryDBasket,
} from "../../../helpers/AllFileExports";
import "../Buttons.Styles.scss";

export default function ThirdButtonsDBasket() {
  ...
  const quitButtonHandler = () => {
    ...
    setStoryQuit(<QuitBeforeThirdStoryDBasket />);
  };
