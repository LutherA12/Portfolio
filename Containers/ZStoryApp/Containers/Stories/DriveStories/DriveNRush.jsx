...
export default function DriveNRush() {
  return (
    <div className="drive-n-rush story-containers">
      {" "}
      You rush him shoving his ass hard to the floor "fuck you!", you exclaim
      "You're lucky I don't kick your --" but before you can finish, you notice
      these things are everywhere now! "This is real stupid" you say to yourself
      "now I need to get away!". You run to the other end of the aisle
