...
export default function AiDangerArticle() {
  return (
    <div className="gradient__bg articles-danger articles">
      ...
      <p>
        ...
        checks & balances we have in place to avoid the Terminator movies is
        quite absurd. <br />
        ...
        <br /> AI in real life is very similar, mostly really boring & not
