...
import {
  DriveNRush,
  DriveNRun,
  QuitBeforeThirdStoryDNeither,
} from "../../../helpers/AllFileExports";
import "../Buttons.Styles.scss";

export default function ThirdButtonsDNeither() {
  ...
  const quitButtonHandler = () => {
    ...
    setStoryQuit(<QuitBeforeThirdStoryDNeither />);
  };
