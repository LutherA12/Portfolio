...
import { ThirdButtonsWNeither } from "../../../helpers/AllFileExports";
import { StoreSound } from "../../../helpers/Data";
import "../Stories.Styles.scss";

export default function WalkNeither() {
  return (
    <div className="walk-neither story-containers" onChange={StoreSound()}>
      {" "}
      ...
      to be done as quickly as possible, not to mention you've walked here so a
      quick exit would be a bit difficult. As you walk from aisle to aisle
