...
export default function DriveNRun() {
  return (
    <div className="drive-n-run story-containers">
      {" "}
      You turn and run, "to hell with this!" you exclaim, however, you now
      notice these things are everywhere! "This is real stupid" you say to
